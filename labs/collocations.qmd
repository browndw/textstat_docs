...
For the purposes of the lab, we'll simply load the data. These particular files are formatted using some simple markup. So we'll use the **from_play()** function in `cmu.textstat` to extract the dialogue.
